...
export let $email = 'info.tdtz@gmail.com';

export let $map = Array('48.409050', '34.998631');

export let $loc = 'Украина, г. Днепр, <br> ул. Краснопольская 9';