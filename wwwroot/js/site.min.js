function include(n){document.write('<script src="'+n+'"><\/script>')}function isIE(){var n=navigator.userAgent.toLowerCase();return n.indexOf("msie")!=-1?parseInt(n.split("msie")[1]):!1}function showSlides(n){if(slideIndex!==n){slideIndex=n;for(var r=$("#tractors").find("#carousel-example-generic .item"),i=document.getElementsByClassName("carousel-indicator-dot"),t=0;t<r.length;t++)r[t].style.display="none";for(t=0;t<i.length;t++)i[t].className=i[t].className.replace(" active","");r[slideIndex].style.display="block";i[slideIndex].className+=" active"}}function getQueryVariable(n){for(var i,u=window.location.search.substring(1),r=u.split("&"),t=0;t<r.length;t++)if(i=r[t].split("="),i[0]==n)return i[1];return!1}function createCookie(n,t,i){var u="",r;i&&(r=new Date,r.setTime(r.getTime()+i*864e5),u="; expires="+r.toUTCString());document.cookie=n+"="+t+u+"; path=/"}function eraseCookie(n){createCookie(n,"",-1)}function getCookieObject(){let n={};return document.cookie.split(";").filter(t=>{t=t.trim().split("="),n[t[0]]=t[1]}),n}var slideIndex,c_name,days;$(".calcul").on("click",function(){ga("send","event","button","call_me");fbq("track","Lead")});$(document).ready(function(){Date.prototype.daysInMonth=function(){return 33-new Date(this.getFullYear(),this.getMonth(),33).getDate()};days=(new Date).daysInMonth();var t=new Date,n=t.getMonth()+1,i=t.getFullYear();n=n<10?"0"+n:n;$(".first-form-title span").empty();$(".first-form-title span").append(days+"."+n+"."+i)});setTimeout(function(){$(".ks").fadeOut(200)},800);setTimeout(function(){$(".vd").fadeIn(200)},1e3);setTimeout(function(){$(".vd").fadeOut(200)},2800);setTimeout(function(){$(".lc").fadeIn(200)},3e3);setTimeout(function(){$(".lc").fadeOut(200)},4800);setTimeout(function(){$(".ks").fadeIn(200)},5e3);setInterval(function(){setTimeout(function(){$(".ks").fadeOut(200)},1800);setTimeout(function(){$(".vd").fadeIn(200)},2e3);setTimeout(function(){$(".vd").fadeOut(200)},3800);setTimeout(function(){$(".lc").fadeIn(200)},4e3);setTimeout(function(){$(".lc").fadeOut(200)},5800);setTimeout(function(){$(".ks").fadeIn(200)},6e3)},6e3),function(n){n(document).ready(function(){n("#copyright-year").text((new Date).getFullYear())})}(jQuery),function(n){isIE()&&isIE()<11&&(n("html").addClass("lt-ie11"),n(document).ready(function(){PointerEventsPolyfill.initialize({})}));isIE()&&isIE()<10&&n("html").addClass("lt-ie10")}(jQuery),function(n){var t=n(".rd-mailform");t.length>0&&n(document).ready(function(){var t=n(".rd-mailform");t.length&&t.rdMailForm({validator:{constraints:{"@LettersOnly":{message:"Please use letters only!"},"@NumbersOnly":{message:"Please use numbers only!"},"@NotEmpty":{message:"Field should not be empty!"},"@Email":{message:"Enter valid e-mail address!"},"@Phone":{message:"Enter valid phone number!"},"@Date":{message:"Use MM/DD/YYYY format!"},"@SelectRequired":{message:"Please choose an option!"}}}},{MF000:"Sent",MF001:"Recipients are not set!",MF002:"Form will not work locally!",MF003:"Please, define email field in your form!",MF004:"Please, define type of your form!",MF254:"Something went wrong with PHPMailer!",MF255:"There was an error submitting the form!"})})}(jQuery),function(n){var t=n(".rd-navbar");t.length>0&&n(document).ready(function(){t.RDNavbar({stuckWidth:768,stuckMorph:!0,stuckLayout:"rd-navbar-static",responsive:{0:{layout:"rd-navbar-fixed",focusOnHover:!1},768:{layout:"rd-navbar-fullwidth"},1200:{layout:t.attr("data-rd-navbar-lg").split(" ")[0]}},onepage:{enable:!1,offset:0,speed:400}})})}(jQuery),function(n){var i=n(".owl-carousel"),t;if(i.length){t="ontouchstart"in window;function r(n){n.preventDefault()}n(document).ready(function(){i.each(function(){for(var i=n(this),e={},s=["-","-xs-","-sm-","-md-","-lg-"],o=[0,480,768,992,1200],f,u=0;u<o.length;u++)for(e[o[u]]={},f=u;f>=-1;f--)!e[o[u]].items&&i.attr("data"+s[f]+"items")&&(e[o[u]].items=f<0?1:parseInt(i.attr("data"+s[f]+"items"))),!e[o[u]].stagePadding&&e[o[u]].stagePadding!==0&&i.attr("data"+s[f]+"stage-padding")&&(e[o[u]].stagePadding=f<0?0:parseInt(i.attr("data"+s[f]+"stage-padding"))),!e[o[u]].margin&&e[o[u]].margin!==0&&i.attr("data"+s[f]+"margin")&&(e[o[u]].margin=f<0?30:parseInt(i.attr("data"+s[f]+"margin")));i.owlCarousel({autoplay:i.attr("data-autoplay")==="true",loop:i.attr("data-loop")!=="false",items:1,mouseDrag:i.attr("data-mouse-drag")!=="false",nav:i.attr("data-nav")==="true",dots:i.attr("data-dots")==="true",dotsEach:i.attr("data-dots-each")?parseInt(i.attr("data-dots-each")):!1,responsive:e,navText:[],onInitialized:function(){if(n.fn.magnificPopup){var i=this.$element.attr("data-lightbox")!==undefined&&this.$element.attr("data-lightbox")!=="gallery",u=this.$element.attr("data-lightbox")==="gallery";i&&this.$element.each(function(){var i=n(this);i.magnificPopup({type:i.attr("data-lightbox"),callbacks:{open:function(){if(t){n(document).on("touchmove",r);n(document).swipe({swipeDown:function(){n.magnificPopup.close()}})}},close:function(){t&&(n(document).off("touchmove",r),n(document).swipe("destroy"))}}})});u&&this.$element.each(function(){var i=n(this);i.find("[data-lightbox]").each(function(){var t=n(this);t.addClass("mfp-"+t.attr("data-lightbox"))}).end().magnificPopup({delegate:".owl-item [data-lightbox]",type:"image",gallery:{enabled:!0},callbacks:{open:function(){if(t){n(document).on("touchmove",r);n(document).swipe({swipeDown:function(){n.magnificPopup.close()}})}},close:function(){t&&(n(document).off("touchmove",r),n(document).swipe("destroy"))}}})})}}})})})}}(jQuery),function(n){var t=n("[data-lightbox]").not('[data-lightbox="gallery"] [data-lightbox]').not(".owl-carousel"),i=n('[data-lightbox^="gallery"]').not(".owl-carousel");(t.length>0||i.length>0)&&n(document).ready(function(){t.length&&t.each(function(){var t=n(this);t.magnificPopup({type:t.attr("data-lightbox")})});i.length&&i.each(function(){var t=n(this);t.find("[data-lightbox]").each(function(){var t=n(this);t.addClass("mfp-"+t.attr("data-lightbox"))}).end().magnificPopup({delegate:"[data-lightbox]",type:"image",gallery:{enabled:!0}})})})}(jQuery);$(document).ready(function(){var n,t;$(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"});$("input[name='phone']").mask("+38(999) 999-99-99");$("#contactForm input, #first-form input").jqBootstrapValidation({preventSubmit:!0,submitError:function(){},submitSuccess:function(n,t){var a,r;t.preventDefault();var i=$("input#name",n).val(),u=$("input#email",n).val(),f=$("input#phone",n).val(),e=$("input#time",n).val(),o=$("input#message",n).val(),s=$("input#model",n).val(),h=$("input#date",n).val(),c=$("input#power",n).val(),l=$("input#status",n).val();form=new FormData;typeof i!="undefined"&&form.append("name",i);typeof u!="undefined"&&form.append("email",u);typeof f!="undefined"&&form.append("phone",f);typeof e!="undefined"&&form.append("time",e);typeof o!="undefined"&&form.append("message",o);(typeof s!="undefined"||typeof h!="undefined"||typeof c!="undefined"||typeof l!="undefined")&&(a="Марка и модель трактора: "+s+"<br> Дата изготовления трактора:"+h+"<br> Мощность: "+c+"<br> Состояние: "+l+"<br>",form.append("message2",a));typeof $("input#file",n).get(0)!="undefined"&&form.append("file",$("input#file",n).get(0).files[0]);r=i;r!==undefined&&r.indexOf(" ")>=0&&(r=i.split(" ").slice(0,-1).join(" "));$.ajax({url:"/contact_me.php",type:"POST",processData:!1,contentType:!1,data:form,cache:!1,success:function(){u!=""?$(n).html("<div class='resp-succ'>"+window.message_thanks+"<\/div>"):$(n).html("<div class='resp-succ'>"+window.message_thanks+"<\/div>")},error:function(){$(n).html("<div class='resp-succ'>Форма не работает. <br> Позвоните пожалуйста.<\/div>")}})},filter:function(){return $(this).is(":visible")}});n=!1;t=0;$(document).mousemove(function(n){(n.pageY<=5||event.clientY<=5)&&(t==0&&$("#rdcp").click(),t=1)});$(".dot").hover(function(){window.innerWidth>768&&($(this).toggleClass("z-index-10"),$(".why-item-box-"+event.target.attributes[1].value+" img").attr("src",$(".why-item-box-"+event.target.attributes[1].value+" img").attr("data-src")),$(".why-item-box-"+event.target.attributes[1].value).toggleClass("hide"))});$(".dot").click(function(){window.innerWidth<=768&&($(".why-item-box-"+event.target.attributes[1].value+" img").attr("src",$(".why-item-box-"+event.target.attributes[1].value+" img").attr("data-src")),$(".why-item-box-"+event.target.attributes[1].value).toggleClass("hide"))});$(".item-box-btn-close").click(function(){window.innerWidth<=768&&$(this).parents(".why-item-box").addClass("hide")})});$(".bt-first-form-redesign").on("click",function(){ga("send","event","button","send_offer");fbq("track","Lead")});$(".green-line_button").on("click",function(){ga("send","event","button","call_me");fbq("track","Lead")});$(".bt-popup").on("click",function(){ga("send","event","click","button");fbq("track","Lead")});if(function(n){n.Lazy("google-map",function(n,t){map=new google.maps.Map(document.getElementById("google-map"),{center:{lat:48.40905,lng:34.998631},zoom:17});var i=new google.maps.Marker({position:{lat:48.40905,lng:34.998631},map:map});t(!0)})}(jQuery),$(function(){$(".lazy").Lazy();$("#google-map").Lazy();$("iframe[data-src]").Lazy()}),slideIndex=0,c_name="__utmz",days=60,getQueryVariable("utm_source")!=""){let n=getQueryVariable("utm_source")||"";createCookie("__utm_source",n,days);let t=getQueryVariable("utm_medium")||"";createCookie("__utm_medium",t,days);let i=getQueryVariable("utm_term")||"";createCookie("__utm_term",i,days);let r=getQueryVariable("utm_campaign")||"";createCookie("__utm_campaign",r,days);let u=getQueryVariable("utm_content")||"";createCookie("__utm_content",u,days)}let yclid=getQueryVariable("yclid")||"";createCookie("__yclid",yclid,days);let gclid=getQueryVariable("gclid")||"";createCookie("__gclid",gclid,days);createCookie("__utm_url",window.location.href.split("?")[0],days);document.referrer.indexOf(location.protocol+"//"+location.host)===0&&createCookie("__utm_referrer",document.referrer,days);$(document).ready(function(){let n=getCookieObject();$("#form-order").submit(function(){let t=$(this),i={contact:{name:t.find('[name="name"]').val(),phone:{action:"add",value:t.find('[name="phone"]').val()},email:{action:"add",value:t.find('[name="email"]').val()},responsible:{type:"linear",value:"Отдел продаж"}},lead:{name:"Заявка с сайта tdtz.in.ua",responsible:{type:"entity",entity:"contact",action:"update"},fields:{"Форма":t.find('[name="abcid"]').val(),utm_source:n.__utm_source,utm_medium:n.__utm_medium,utm_campaign:n.__utm_campaign,utm_content:n.__utm_content,utm_term:n.__utm_term,Gclid:n.__gclid,Yclid:n.__yclid,GAclientID:n._ga,"Страница обращения":n.__utm_url,"Коментар":""},status_id:"10735228"}};$.post("https://blackbox.bpmcenter.pro/api/33278e359d2ccdf04f7cfc90c589b61c/hook",i,n=>{console.log(n)})})});
/**
 * @module       UIToTop
 * @author       Matt Varone
